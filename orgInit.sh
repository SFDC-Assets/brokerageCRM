...
#create scratch org
sfdx shane:org:create -f config/project-scratch-def.json -s -d 14 --userprefix broker -o force.demo
...
# sfdx automig:dump -u michellelewis@michellelewis-20210819.demo -o Commission_Statement__c